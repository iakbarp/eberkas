...
<head>
    <meta charset="UTF-8">
    <title>404 page animation - missing book</title>
...
<nav class="shelf">
    <a class="book home-page" href="{{url('/')}}">Home</a>
    <a class="book about-us" href="{{url('profile')}}">Profil</a>
    <a class="book contact" href="{{url('eBerkas')}}">eBerkas</a>
    @if (!\Illuminate\Support\Facades\Auth::guest())
        @if(\Illuminate\Support\Facades\Auth::user()->role_id==1)
    <a class="book faq" href="{{url('admin')}}">Laman Admin</a>
            @endif
@endif
