                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <ul class="nav text-center">
                            ...
                            <li><a href="inside.html">Employes List</a></li>
                            <li><a href="services.html">e-Berkas</a></li>
                        </ul>
                    </div>
                    <div class="col-md-3">
                        <ul class="dropdown nav-divider">
                            <a href="#" class="dropdown-toggle profile-image" data-toggle="dropdown" style="text-decoration: none">
                                <img src="images/brand-nav.png" class="img-circle special-img" >Fahmi Rizky</a>
            ...
            <div class="row">
                <div class="col-md-12 text-center ">
                    <div class="footer-widget border">
                        <p class="pull-left"><small>&copy; UNESA Informatic Engineering. All Rights Reserved.</small></p>
                        <p class="pull-right"><small> Created by  <a href="http://github.com/vreallyla" ta>Fahmi Rizky</a> </p>
